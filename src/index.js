module.exports = function toReadable(number) {
    ...
    if (i <= 10) return oneDigitAnumber[i];
    if (i < 20 || i == 10) return TwoDigitAnumber[i[1]];
    if (i.length == 2 & i % 10 == 0) return TwoDigitAnumberTenths[i[0]];
    if (i.length == 2 & i >= 20 || i <= 99) return TwoDigitAnumberTenths[i[0]] + ' ' + oneDigitAnumber[i[1]];
    if (i % 100 == 0) return oneDigitAnumber[i[0]] + ' ' + 'hundred';
    if (i > 100 & i % 10 == 0) return oneDigitAnumber[i[0]] + ' ' + 'hundred' + ' ' + TwoDigitAnumberTenths[i[1]];
    if (i[1] == 0) return oneDigitAnumber[i[0]] + ' ' + 'hundred' + ' ' + oneDigitAnumber[i[2]];
    if (i[1] == 1) {
